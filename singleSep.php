						...
						<ul class="dropdown">
							<li><a class="scroll" href="#home">Home </a></li>
       	                    <li data-filtertext="listview autodivider">
                                     <a href="singleSep.php">Separados</a>
                            </li>
                            <li data-filtertext="listview autodivider">
                                     <a href="../../mobile_z/fechamentoDados_mobile.php">Pendentes</a>
                            </li>
                            <!--
           ...
           <div class="specials">
				<div class="accordion">
							<div class="accordion-section">
								<a class="accordion-section-title" href="#accordion-1"><img src="images/a1.jpg" alt=" " />Cliente 1 <i class="fa fa-chevron-down"></i><div class="clearfix"></div>
								</a>
							...
							<div class="accordion-section">
								<a class="accordion-section-title" href="#accordion-2"><img src="images/a2.jpg" alt=" " />Cliente 2 <i class="fa fa-chevron-down"></i><div class="clearfix"></div>
								</a>
